...
interface AnimatedMarqueeHeroProps {
  ...
  className?: string;
  /**
   * Added for this codebase: the landing hero's CTA has to start the real Google
   * sign-in flow, so the button needs a click handler. Optional — omitting it
   * leaves the component behaving exactly as originally specified.
   */
  onCtaClick?: () => void;
}
...
export const AnimatedMarqueeHero: React.FC<AnimatedMarqueeHeroProps> = ({
  ...
  // Annotated as `Variants` so `type: "spring"` narrows to the literal rather
  // than widening to `string`, which TypeScript rejects.
