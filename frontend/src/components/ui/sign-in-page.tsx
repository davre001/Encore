...
export function LoginPage({ mode = 'signin' }: LoginPageProps) {
  ...
  return (
    <div className="h-screen w-full bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 flex">
      ...
      <div className="flex-1 flex items-center justify-center bg-white">
        <div className="w-full max-w-md p-8">
          ...
          <button
            onClick={() => router.push('/')}
            aria-label="Back to home"
            className="md:hidden mb-6 w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200 transition-all"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-xl text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-blue-500 outline-none"
                required
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-xl text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-blue-500 outline-none"
                  required
                />
                <button
                  type="button"
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <button
                ...
                className="flex items-center justify-center px-4 py-3 border border-gray-300 rounded-xl opacity-50 cursor-not-allowed"
              >
                {/* GitHub SVG */}
