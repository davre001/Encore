...
export function OrbitalHeroSection({
  ...
  useEffect(() => {
    ...
    function drawSun(k: number, t: number) {
      ...
      haze.addColorStop(0.4, `rgba(255,168,104,${0.014 * k})`);
      haze.addColorStop(1, "rgba(240,140,80,0)");
      ctx!.fillStyle = haze;
      ctx!.beginPath();
      ...
      outer.addColorStop(0.3, `rgba(255,176,104,${0.1 * k})`);
      outer.addColorStop(0.62, `rgba(240,140,80,${0.025 * k})`);
      ...
      bloom.addColorStop(0.42, `rgba(255,246,236,${0.7 * k})`);
      bloom.addColorStop(0.72, `rgba(${r},${g},${b},${0.22 * k})`);
      bloom.addColorStop(1, "rgba(240,150,90,0)");
      ctx!.fillStyle = bloom;
      ctx!.beginPath();
    ...
    function render(t: number) {
      ...
      if (C.showSunTrack) {
        ...
        if (P.ok) {
          ...
          // Encore de-yellow: the drift-track reads burnt copper, not gold.
          grad.addColorStop(0, `rgba(255,188,132,${k})`);
          grad.addColorStop(0.45, `rgba(228,120,64,${0.55 * k})`);
          grad.addColorStop(1, "rgba(190,80,42,0)");
